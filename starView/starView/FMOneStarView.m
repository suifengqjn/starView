...
@interface FMOneStarView(){
    UIColor *bgStarColor;   //填充颜色
}

@end

@implementation FMOneStarView

+ (UIImage *)starWithRadius:(float)radius withFillColor:(UIColor *)fillColor
{
    FMOneStarView *view = [[self alloc] initWithFrame:CGRectMake(0, 0, radius*4, radius*4) withFillColor:fillColor];
